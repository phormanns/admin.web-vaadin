...
public class PanelToolbar extends HorizontalLayout implements ClickListener{
	...
	public PanelToolbar(String source){
		super();
	...
	public void buttonClick(ClickEvent event) {
		...
		AbstractFactory windowFactory = FactoryProducer.getFactory("subwindow");
		String type = null;
		String action = null;
		...
		Window window = (Window) windowFactory.getSubWindow(type,action);
		if(window != null)
